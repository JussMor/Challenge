  ...
  return (
    <div className={`navbar-wrapper ${styles.navBarWrapper}`}>
      <Navbar
        sticky="top"
        id="navbar"
        className={`navbar-expand-lg ${styles.navBar}`}
        ...
        <Container className={styles.navBarContainer}>
          <Navbar.Brand className={styles.navBarBrand}>
            ...
            >
              ...
              />
              <img
                src={props.logo_sticky}
                alt="Coffe Make"
                className={`logo-sticky ${styles.logo_sticky}`}
              />
            </a>
          </Navbar.Brand>
...
NavBar.defaultProps = {
  logo: require("../../../resources/images/logo.webp"),
  logo_sticky: require("../../../resources/images/logo_sticky.webp"),
};
